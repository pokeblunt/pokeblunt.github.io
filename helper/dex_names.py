"""National dex names, index 0 = #1 Bulbasaur.

Single source of truth for name <-> dex number. Previously this list lived
inside showdown_link_to_json.py and replay_stats.py pulled it back out with a
regex, which would have broken the moment that file was reformatted.
"""
...
assert len(NAMES) == 1025, "national dex should have 1025 entries"
